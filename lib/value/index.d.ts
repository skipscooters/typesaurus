 ...
 */
export declare type UpdateValue<T> = T extends number
...
declare function value<T extends number>(
  kind: 'increment',
  number: number
): ValueIncrement
declare function value<T extends Array<any>>(
  kind: 'arrayUnion',
  payload: any[]
): ValueArrayUnion
declare function value<T extends Array<any>>(
