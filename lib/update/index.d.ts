 ...
 */
export declare type ModelUpdate<Model> = {
 ...
 * @param data - the document data to update
 */
declare function update<Model>(collection: Collection<Model>, id: string, data: ModelUpdate<Model>): Promise<void>;
/**
 * @param ref - the reference to the document to set
 * @param data - the document data to update
 */
declare function update<Model>(ref: Ref<Model>, data: ModelUpdate<Model>): Promise<void>;
